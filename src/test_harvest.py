...
# This line tells Python: "The folder I am currently in is the root of the project"
sys.path.append(os.getcwd())

import logging
# Now it will find 'engine' correctly
...
# Price is 89.63, Qty is 0.02 -> Notional = 1.120375
test_actions = [{
    "coin": "SOL",
