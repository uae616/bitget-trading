                ...
                if (msg['event']) {
                    ...
                    if (msg.event === 'error') {
                        ...
                        if (code === 30033 || code === '30033') {
                            this.logger.info('Service upgrade in progress - connection might drop in 60s before automatic reconnect', { ...websocket_util_js_1.WS_LOGGER_CATEGORY, wsKey, code });
                        }
                    }
                    return results;
                }
