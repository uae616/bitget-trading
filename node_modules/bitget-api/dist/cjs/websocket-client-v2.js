...
class WebsocketClientV2 extends BaseWSClient_js_1.BaseWebsocketClient {
    /**
     * Request connection of all dependent (public & private) websockets, instead of waiting for automatic connection by library
     */
    connectAll() {
        return [
            this.connect(websocket_util_js_1.WS_KEY_MAP.v2Private),
            this.connect(websocket_util_js_1.WS_KEY_MAP.v2Public),
        ];
    }
    ...
    getSubRequest(instType, topic, coin = 'default') {
        if ((0, websocket_util_js_1.isPrivateChannel)(topic)) {
    ...
    subscribeTopic(instType, topic, coin = 'default') {
        ...
        const isPrivateTopic = (0, websocket_util_js_1.isPrivateChannel)(topic);
        const wsKey = isPrivateTopic ? websocket_util_js_1.WS_KEY_MAP.v2Private : websocket_util_js_1.WS_KEY_MAP.v2Public;
